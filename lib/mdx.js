...
/* Optional: intrinsic size for local images to reduce CLS.
   We attempt to import image-size; if unavailable, we skip silently. */
let imageSize = null;
try {
  // eslint-disable-next-line import/no-extraneous-dependencies, global-require
  imageSize = (await import("image-size")).default ?? null;
} catch {
  // not installed — completely optional
}
